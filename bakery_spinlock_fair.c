 ...
 *
 *  Operating Systems Homework 4.5: Fair Bakery Spinlock
 * 
...
// Atomic xadd provided by operating systems instructor
/*
...
// Atomic xadd model for SMACK 
int atomic_xadd(int *ptr) {
  int ret = 1;
