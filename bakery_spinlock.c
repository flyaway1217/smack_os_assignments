 ...
 *  
 *  Operating Systems Homework 4.4: Bakery Spinlock
 *
...
// Atomic compare and exchange provided by operating systems instructor
/*
...
// Atomic compare and exchange model provided by Montgomery
...
int main(int argc, char *argv[]) {
  ...
  // For verification we'll hard code the command line arguments
  /* 
  ...
  */
  ...
  in_cs = 0;
  numThreads = 3; //atoi(argv[1]);
  int numSeconds = 10; //atoi(argv[2]);
  int i = 0;
